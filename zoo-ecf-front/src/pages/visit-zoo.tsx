...
const Restauration: NextPage<Props> = ({ }) => {
    ...
    <br />
        <div>
            ...
            <br />
            <br />
            <a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Services</a>/<a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Visite du zoo en train</a>
            <br />
            <br />
            <p className="text-4xl font-black text-gray-900 dark:text-white">Visite du zoo en train</p>
            <br />
            <p className="mb-3 text-black-500 dark:text-black-400">Embarquez pour une aventure unique avec notre passionnant voyage à travers le zoo en train.</p>
            <p className="mb-3 text-black-500 dark:text-black-400">Profitez du confort du train tout en explorant les divers habitats et en observant de près nos incroyables animaux.
            </p>
            <p className="mb-3 text-black-500 dark:text-black-400">Notre guide expert partagera des informations fascinantes sur chaque espèce, vous offrant une expérience éducative et divertissante.
            </p>
            <p className="mb-3 text-black-500 dark:text-black-400">Détendez-vous et laissez-vous emporter par cette visite inoubliable du zoo, une manière pittoresque et enrichissante de découvrir la diversité de la vie animale, tout cela à bord de notre train exclusif.
            </p>
        </div>
    </div>
