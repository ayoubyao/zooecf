    ...
    <>
      <div>
        ...
        <div>
          ...
          <p className="mb-3 text-black-500 dark:text-black-400">
            Profitez du confort du train tout en explorant les divers habitats
            et en observant de près nos incroyables animaux.
          </p>
          <p className="mb-3 text-black-500 dark:text-black-400">
          ...
          <p className="mb-3 text-black-500 dark:text-black-400">
            Détendez-vous et laissez-vous emporter par cette visite inoubliable
            du zoo, une manière pittoresque et enrichissante de découvrir la
            diversité de la vie animale, tout cela à bord de notre train
            exclusif.
          </p>
        </div>
      </div>
