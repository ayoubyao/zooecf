...
const Restauration: NextPage<Props> = ({ }) => {
    ...
    <br />
        <div>
            ...
            <br />
            <br />
            <a href="/service" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Services</a>/<a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Visite des habitats avec un guide</a>
            <br />
            <br />
            <p className="text-4xl font-black text-gray-900 dark:text-white">Visite des habitats avec un guide</p>
            <br />
            <p className="mb-3 text-black-500 dark:text-black-400">Participez à une expérience immersive lors de notre visite des habitats, guidée par nos experts passionnés.</p>
            <p className="mb-3 text-black-500 dark:text-black-400">Cette visite gratuite vous permettra de découvrir et d'explorer divers habitats, tout en bénéficiant des connaissances approfondies de nos guides expérimentés.
            </p>
            <p className="mb-3 text-black-500 dark:text-black-400">Plongez dans la richesse de la nature et apprenez-en davantage sur les écosystèmes fascinants qui entourent chaque habitat. Une aventure éducative et divertissante vous attend, sans frais supplémentaires !
            </p>
        </div>
    </div>
