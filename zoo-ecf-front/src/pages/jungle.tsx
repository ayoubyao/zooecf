...
const Restauration: NextPage<Props> = ({ }) => {
    ...
    <br />
        <div>
            ...
            <br />
            <br />
            <a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Habitat</a>/<a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Jungle</a>
            <br />
            <br />
            <p className="text-4xl font-black text-gray-900 dark:text-white">Jungle</p>
            <br />
            <br />

            <img className="h-auto max-w-full" src="e0ce66feff4b.jpg" alt="" />
            <br />
            <p className="mb-3 text-black-500 dark:text-black-400">En explorant notre jungle, vous pénétrerez dans un royaume aussi luxuriant que mystérieux, plongeant profondément au cœur de la nature sauvage.
            </p>
            <p className="mb-3 text-black-500 dark:text-black-400">Découvrez nos majestueux tigres, panthères et autres animaux évoluant dans cet écosystème exotique. Chaque pas vous rapprochera de la splendeur captivante de cette jungle, où la vie sauvage prospère dans toute sa diversité.
            </p>
            <p className="mb-3 text-black-500 dark:text-black-400">Bienvenue dans une expérience immersive, où la beauté et la majesté de la nature prennent vie sous vos yeux émerveillés.
            </p>
            <br />
        </div>
        <div className="grid grid-cols-3 gap-4">
            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Panda roux | Rox</h5>
                <p className="font-normal text-gray-700 dark:text-gray-400">En savoir plus</p>
                <br />
                <img src="animal1.png" alt="" />
            </a>

            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">

                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">PANDOUDOU "Panda"</h5>
                <p className="font-normal text-gray-700 dark:text-gray-400"> En savoir plus </p>
                <br />
            ...
            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">MATOU "Panthère noir"</h5>
                <p className="font-normal text-gray-700 dark:text-gray-400"> En savoir plus</p>
                <br />
                <img src="penthere.png" alt="" />
            </a>
            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">

                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Gorille "Kong"</h5>
                <p className="font-normal text-gray-700 dark:text-gray-400"> En savoir plus</p>
                <br />
