...
const Restauration: NextPage<Props> = ({ }) => {
    ...
    <br />
        <div>
            ...
            <br />
            <br />
            <a href="/habitat" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Habitat</a>/<a href="/savane" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Savane</a>
            <br />
            <br />
            <p className="text-4xl font-black text-gray-900 dark:text-white">Savane</p>
            <br />
            <br />

            <img className="h-auto max-w-full" src="4fd8d9ddbbfb.jpg" alt="" />
            <br />
            <p className="mb-3 text-black-500 dark:text-black-400">Cette zone africaine reconstituée est l'endroit idéal pour observer les majestés de la faune sauvage, des éléphants majestueux aux lions rugissants, à travers un paysage où se mêlent graminées et arbres épais.
            </p>
            <p className="mb-3 text-black-500 dark:text-black-400">Les sentiers circulaires offrent une vue panoramique sur l'ensemble de l'habitat, un sanctuaire pour les espèces menacées sert d'exemple de conservation en plein air, incarnant l'engagement du Zoo à préserver et protéger le patrimoine naturel.
            </p>
            <br />
        </div>
        <div className="grid grid-cols-3 gap-4">
            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">éléphant // Dumbo</h5>
            ...
            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Zèbre // zebra</h5>
                <p className="font-normal text-gray-700 dark:text-gray-400"> En savoir plus </p>
                <br />
                <img src="zebre.png" alt="" />
            </a>

            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">

                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Lion // Lionnel</h5>
                <p className="font-normal text-gray-700 dark:text-gray-400"> En savoir plus</p>
                <br />
            ...
            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Antilope // Anti</h5>
                <p className="font-normal text-gray-700 dark:text-gray-400"> En savoir plus</p>
                <br />
