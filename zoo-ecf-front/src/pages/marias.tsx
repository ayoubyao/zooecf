...
const Restauration: NextPage<Props> = ({ }) => {
    ...
    <br />
        <div>
            ...
            <br />
            <br />
            <a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Habitat</a>/<a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Marias</a>
            <br />
            <br />
            <p className="text-4xl font-black text-gray-900 dark:text-white">Marias</p>
            <br />
            <br />

            <img className="h-auto max-w-full" src="b802d4ed329f.jpg" alt="" />
            <br />
            <p className="mb-3 text-black-500 dark:text-black-400">L'habitat Marais est une énigme végétale et animale qui offre à ses visiteurs un véritable voyage dans les profondeurs des récifs d'eau.
            </p>
            <p className="mb-3 text-black-500 dark:text-black-400">Ce lieu emblématique du zoo se distingue par sa composition complexe de zones humides et marécageuses, où la vie aquatique s'épanouit sous l'ombre protectrice de grands cyprès et de plantes palustres.
            </p>
            <br />
        </div>
        <div className="grid grid-cols-3 gap-4">
            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Flamant rose // Rosette</h5>
                <p className="font-normal text-gray-700 dark:text-gray-400">En savoir plus</p>
                <br />
                <img src="flamant.png" alt="" />
            </a>

            <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">

                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Crocodile // croco</h5>
                <p className="font-normal text-gray-700 dark:text-gray-400"> En savoir plus </p>
                <br />
                <img src="crocodile.png" alt="" />
            </a>
        </div>
    </div>
