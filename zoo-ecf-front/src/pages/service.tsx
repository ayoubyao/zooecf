...
const Restauration: NextPage<Props> = ({ }) => {
    ...
    <br />
        <div>
            ...
            <br />
            <br />
            <a href="/service" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Services</a>
            <br />
            <br />
            <p className="mb-3 text-black-500 dark:text-black-400">Explorez les divers services offerts au sein du Zoo Arcadia.</p>
      
            <p className="text-4xl font-black text-gray-900 dark:text-white">Tous nos services</p>
            <br />
       
           <ul>
            <li>
            <a href="/visit-zoo" className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800'>Visite du zoo en train</a>
            </li>
            <br />
            <li>
            <a href="/viste-habitat" className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800'>Visite des habitats avec un guide</a>
            </li>
            <br />
            <li>
            <a href="/restauration" className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800'>Restauration</a>
            </li>
           </ul>
