...
const Restauration: NextPage<Props> = ({ }) => {
    ...
    return <><div>
        ...
        <div>
            ...
            <br />
            <br />
            <a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Services</a>/<a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Restauration</a>
            <br />
            <br />
            <p className="text-4xl font-black text-gray-900 dark:text-white">Restauration</p>
            <br />
            <p className="mb-3 text-black-500 dark:text-black-400">Profitez d'un délicieux repas devant l'enclos de nos éléphants qui s'étend sur une vaste plaine.</p>
            <p className="mb-3 text-black-500 dark:text-black-400">Nous vous proposons une cuisine savoureuse et variée, issue des producteurs locaux.
            </p>
        </div>
