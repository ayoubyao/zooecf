    ...
    <div className='flex flex-wrap justify-center px-10 py-3 relative'>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li className='max-lg:border-b max-lg:px-3 max-lg:py-3'><link href='/'
              className='hover:text-[#007bff] text-[#007bff] font-semibold block text-[15px]'>Acceuil</link>
          </li>
          ...
          <li className='max-lg:border-b max-lg:px-3 max-lg:py-3'>
            <link href='/nouscontacter'
              className='hover:text-[#007bff] text-gray-600 font-semibold text-[15px] block'>Nous contacter</link>
              </li>
